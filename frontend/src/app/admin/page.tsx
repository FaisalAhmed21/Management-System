...
export default function AdminOverview() {
  ...
  if (loading) {
    return <div className="flex items-center justify-center h-64 text-ink-muted">Loading overview...</div>;
  }

  return (
    <div>
      <h1 className="text-2xl font-bold text-ink mb-6">System Overview</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div key={i} className="bg-surface border border-border rounded-xl p-6 shadow-sm">
            <h3 className="text-ink-muted text-sm font-medium">{stat.label}</h3>
